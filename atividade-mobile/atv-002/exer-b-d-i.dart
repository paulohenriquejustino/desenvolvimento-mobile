...
void main () {
  ...
  switch(opcao) {
    ...
    for (int num = 0; num <= 100; num++){
      ...
      if (num % 2 == 0) { //Para cada num dividido por 2 com o resto 0 será adicionado na lista.
        //Guardando os números dentro da lista criada.
        numeros.add(num);
      }
    }
  
    print("Os números pares entre 0 e 100 são: $numeros"); // Para mostar a lista coloque o nome da sua lista.
    break;
    ...
    //Utilizando for para gerar número de 0 a 100.
    for (int num = 1; num <= 10; num++) { //Contagem de 1 a 10 com incrementação!(num++)
      ...
      numeros.forEach((numero) { // percorrer toda a lista

        if (numero >= min && numero <= max) { // Se numero for MAIOR ou igual ao MINIMO, é tambem numero for MENOR ou igual ao Maximo...
       ...
       int numElementos = dentrointervalo.length; // Usando função para contar quantos números tem na minha lista!
       int numElemento = foraintervalo.length; // Usando função para contar quantos números tem na minha lista!
       // Saída
